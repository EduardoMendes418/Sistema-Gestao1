<?php 
	...
	$verifica_categoria = MySql::conectar()->prepare("SELECT * FROM `tb_site.categorias` WHERE slong = ?");
	...
	$post = MySql::conectar()->prepare("SELECT * FROM  `tb_site.noticias` WHERE slong = ? AND categoria_id = ?");	
