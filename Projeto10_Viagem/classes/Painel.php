...
//FUNCAO DO SLONG PARA CONVERTER LETRAS COM ACENTUAÇÃO
		public static function generateSlong($str){
...
//DIRECIONAMETO DA PAGI HOME.PHP
...
//NOSSO TEMPO DE LIMITE PARA LIMPAR USUARIOS  DE VISITAS NO BANCO DE DAODS
		public static function listarUsuariosOnline(){
			self::limparUsuariosOnline();
			$sql = MySql::conectar()->prepare("SELECT * FROM `tb_admin.useronline`");
			$sql->execute();
			return $sql->fetchAll();
		}
		...
		public static function limparUsuariosOnline(){
			...
			$sql = MySql::conectar()->exec("DELETE FROM `tb_admin.useronline` WHERE utima_acao < '$date' - INTERVAL 1 MINUTE");
		}
...
//ASSIM QUE INSERIR UMA IMAGEM DELE A OUTRA		
		public static function deleteFile(){
			@unlink('/uploads/'.$file);
		}

//CADASTRO DO DEPOIMENTOS
...
//FUNCAO PARA ATUALIZAR O COMENTARIOS NO DB
...
//FUNCAO DELETAR REGISTRO LISTADEPOIMENTOS
...
//ORDENANDO AS POSIÇÃO DAS LISTA DE DEPOIMENTOS
